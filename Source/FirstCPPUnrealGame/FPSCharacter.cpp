...
FHitResult AFPSCharacter::instantShot()
{
	...
	FCollisionQueryParams tracePrams(SCENE_QUERY_STAT(instantShot), true, GetInstigator());
	FHitResult hit(ForceInit);
	GetWorld()->LineTraceSingleByChannel(hit, rayLocation, endTrace, ECC_Visibility, tracePrams);
